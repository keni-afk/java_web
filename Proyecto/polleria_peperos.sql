...
drop database if exists polleria_peperos; 

create database polleria_peperos;

use polleria_peperos;

drop table if exists distrito; 

create table distrito(
codigo_distrito int primary key auto_increment,
...
insert into clientes(nomcli,apematcli,apepatcli,telcli,direcli,correocli,fechanac_cli,codigo_distrito,estado_clientes)
...
insert into empleados(nomemp,apematemp,apepatemp,telemp,direemp,correoemp,fechanacimiento_emp,dniemp,idrol,codigo_distrito,estado_empleados)
...
transferencia int(30) not null,
estado_metodos bit not null,
...
nombre varchar(40),
numero_caja int (40) not null,
estado_boleta bit not null,
iddepe int not null,
foreign key(iddepe) references detalle_pedidos(iddepe),
idemp int not null,
foreign key(idemp) references empleados(idemp),
idcliente int not null,
foreign key(idcliente) references clientes(idcliente),
idmetodo int not null,
foreign key(idmetodo) references metodo_pagos(idmetodo)
)engine=InnoDB character set=utf8;
